...
public class DataSourceProvider {
    ...
    public static class DriverManagerDataSource implements DataSource {
        ...
        public Connection getConnection() throws SQLException {
            return getConnection(getDriverClass(), getUrl(), getUsername(), getPassword());
        }

        public Connection getConnection(String username, String password) throws SQLException {
            return getConnection(getDriverClass(), getUrl(), username, password);
        }

        private Connection getConnection(String driver, String url, String username, String password) throws SQLException {
